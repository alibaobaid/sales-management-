class SalespeopleController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @salesperson.save
        format.html { redirect_to @salesperson, notice: 'تمت عملية الاضافة بنجاح' }
  ...
  def update
    respond_to do |format|
      if @salesperson.update(salesperson_params)
        format.html { redirect_to @salesperson, notice: 'تمت عملية التعديل بنجاح' }
  ...
  def destroy
    @salesperson.destroy
    respond_to do |format|
      format.html { redirect_to salespeople_url, notice: 'تمت عملية الحذف بنجاح' }
  ...
  private
    ...
    def salesperson_params
      params.require(:salesperson).permit(:name, :city, :phone_NO, :amount_of_box, :amount_of_gallon, :for_him, :to_him)
    end
end
