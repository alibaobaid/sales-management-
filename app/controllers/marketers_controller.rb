class MarketersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @marketer.save
        format.html { redirect_to marketers_url, notice: 'تمت عملية الاضافة بنجاح' }
  ...
  def update
    respond_to do |format|
      if @marketer.update(marketer_params)
        format.html { redirect_to marketers_url, notice: 'تمت عملية التعديل بنجاح' }
  ...
  def destroy
    @marketer.destroy
    respond_to do |format|
      format.html { redirect_to marketers_url, notice: 'تمت عملية الحذف بنجاح' }
